package com.peng.dynamitThreadPool.utils;
...
public class SlidingWindow {
    ...
    public static void main(String[] args) {
        //1秒一个时间片，窗口共5个
//        SlidingWindow window = new SlidingWindow(1, 9);
        SlidingWindow window = new SlidingWindow(1000, 1, 10);
...
//        lastAddTimestamp = SystemClock.now();
    ...
    public synchronized int addAndGetCount(long count) {
        //当前自己所在的位置，是哪个小时间窗
        int index = locationIndex();
//        System.out.println("index:" + index);
        //然后清空自己前面windowSize到2*windowSize之间的数据格的数据
